    ...
    <div class="max-w-full px-4 sm:px-6 lg:px-8 flex justify-between pt-4">
        ...
        <div class="shrink-0 flex items-center min-w-[20rem]">
            <a href="{{ route('dashboard') }}" class="flex items-center">
                ...
                <p class="w-64 ml-6 font-medium text-stone-50 [text-shadow:_0_4px_4px_rgb(0_0_0_/_0.4)]">Международный институт дизайна и сервиса</p>
            </a>
        </div>
        ...
        <div class="flex items-center min-w-[20rem]">
            ...
            <div class="ml-8 font-medium">
                <p class="text-stone-50 [text-shadow:_0_4px_4px_rgb(0_0_0_/_0.4)]">+7 (351) 202-00-73</p>
                <p class="text-stone-50 [text-shadow:_0_4px_4px_rgb(0_0_0_/_0.4)]">info@midis.ru</p>
            </div>
        </div>
                ...
                <x-slot name="trigger">
                    <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                        <!-- <div>{{ Auth::user()->name }}</div> -->
                            <div class="text-stone-50 font-normal text-lg [text-shadow:_0_4px_4px_rgb(0_0_0_/_0.4)]">Мой профиль</div>

                        <div class="ms-1 text-stone-50 [text-shadow:_0_4px_4px_rgb(0_0_0_/_0.4)]">
