<x-app-layout>
    ...
    <div class="w-full h-full flex flex-col items-center">
        ...
        <!--Поменять цвет фона на такой же как на входе и регистрации-->
        <div class="font-kslab uppercase mt-10 flex flex-col justify-center items-center text-3xl text-orange-600">
            <p>Где вы планируете проходить обучение?</p>
            <p class="mt-8">Колледж на базе 9 классов / 11 классов</p>
        </div>

        <div class="xl:columns-2 mt-14">
            <div class="bg-white p-10 rounded-xl w-[500px] mb-10 mx-6">
